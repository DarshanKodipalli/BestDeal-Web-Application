...
public class SoundSystem extends HttpServlet{
	private String id;
	private String name;
	...
	public SoundSystem(String name, double price, String image, String manufacturer,String model,String sku){
		this.name=name;
		this.price=price;
		this.image=image;
