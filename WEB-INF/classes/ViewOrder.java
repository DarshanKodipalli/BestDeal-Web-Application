...
/*		utility.printHtml("LeftNavigationBar.html");*/
		...
		if(request.getParameter("Order")!=null && request.getParameter("Order").equals("CancelOrder"))
		{
			if(request.getParameter("orderName") != null)
			{
				...
				try{
					getConnection();
					String deleteproductsQuery ="Delete from orders where o_id=?";
					System.out.print(request.getParameter("orderName"));
					PreparedStatement pst = conn.prepareStatement(deleteproductsQuery);
					pst.setString(1,request.getParameter("orderId"));			
					pst.executeUpdate();
		            ...
		            pw.print("<a href='#'>");
		            pw.print("<img style='margin-left:110%' style='width:100%' src='https://cdn0.iconfinder.com/data/icons/e-commerce-glyph-black-1/2048/1036_-_Cancel_Order-512.png' class='img-responsive'>");
		            pw.print("<div class='card-caption'>");
		            pw.print("</div></a></div>");
		            pw.print("<div class='card-body'>");
		            pw.print("<div class='lead'><h3>Your order is Cancelled!</h3></div>");
		            pw.print("<ul class='details'>");
		            pw.print("<li>Product Cancelled: <span style='font-weight:bolder;'>"+request.getParameter("orderName")+"</span></li>");
		            pw.print("<li>Expect the refund in <span style='font-weight:bolder;'>"+"3 Working days!"+"</span></li>");
